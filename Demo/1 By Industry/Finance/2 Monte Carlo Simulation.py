# Databricks notebook source exported at Wed, 14 Sep 2016 17:00:51 UTC
...
diceDF.registerTempTable("dice_rolls")
...
display(totalDF.join(diceDF).selectExpr(["RollValue", "(RollCount / Total) as Probability"]).sort("RollValue"))
